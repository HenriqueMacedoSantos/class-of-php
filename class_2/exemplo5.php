  ...
  <body>
    <main class="container-fluid">
      ...
      <section>
        ...
        <p>
          Desenhe um programa que leia o raio de um círculo (3). Seu programa dever calcular a área e calcular o perímetro do círculo
        </p>
        <?php
          $raio;
          $area;
          ...
          $perimetro = pi() * 2 * $raio;
          echo "<p>Area: ".$area.
               "<br>perímetro: ".$perimetro."</p>";

          echo "Cálculo: π * $raio = $area";
          echo "<br>Cálculo: π * 2 * $raio = $perimetro";
        ?>
      </section>
      <nav>
        <ul>
