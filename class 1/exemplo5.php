  ...
  <body>
    <main class="container-fluid">
      ...
      <section>
        ...
        <p>
          Um algoritmo que leia dois valores inteiros e retorne a idade de borigodolfa. Os valores serão: 2000(nascimento) e 2020(ano atual).
        </p>
        <?php
          $nome;
          $nascimento;
          ...
          echo "Cálculo: $nascimento + $atual = $idade";
        ?>
      </section>
      <nav>
        <ul>
